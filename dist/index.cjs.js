...
function FastImageBase({
  ...
  const resolvedDefaultSource = reactNative.Platform.OS === 'ios' ? defaultSource : defaultSource && ((_Image$resolveAssetSo = reactNative.Image.resolveAssetSource(defaultSource)) === null || _Image$resolveAssetSo === void 0 ? void 0 : _Image$resolveAssetSo.uri) || null;
  return /*#__PURE__*/React__default.createElement(reactNative.View, {
    style: [styles.imageContainer, style],
    ref: forwardedRef
